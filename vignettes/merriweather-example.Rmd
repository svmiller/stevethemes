---
title: "An Example Using Merriweather"
---
...
```{r}
example_plot() + theme_steve(style = "merri")
```
...
```{r}
example_plot("faceted_line") + theme_steve(style = "merri")
```
...
```{r}
example_plot("bar") + theme_steve(style = "merri")
```
...
```{r}
example_plot("scatter") + theme_steve(style = "merri")
```
